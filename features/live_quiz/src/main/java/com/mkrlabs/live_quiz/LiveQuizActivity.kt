...
import com.mkrlabs.live_quiz.databinding.ActivityLiveQuizBinding
import com.mkrlabs.live_quiz.ui.QuizHomeViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class LiveQuizActivity :   BaseActivity<QuizHomeViewModel, ActivityLiveQuizBinding>() {

    override val mViewModel: QuizHomeViewModel by viewModels()

    override fun getViewBinding(): ActivityLiveQuizBinding =
        ActivityLiveQuizBinding.inflate(layoutInflater)
