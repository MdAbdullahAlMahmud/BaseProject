...
import com.mkrlabs.common.core.base.data.model.WebSocketNotificationModel
import com.mkrlabs.common.core.base.interfaces.CommunicatorImpl
import com.mkrlabs.common.core.base.utils.ResponseCode
    ...
    suspend fun <T> callService(
        ...
        try {
            ...
            if (!response.isSuccessful) {
                ...
                val errorResponse: BaseResponse<T>? = gson.fromJson(response.errorBody()?.charStream(), type)

                val message = errorResponse?.message?.ifEmpty { defaultErrorMessage } ?: defaultErrorMessage
                showMessage(message)
